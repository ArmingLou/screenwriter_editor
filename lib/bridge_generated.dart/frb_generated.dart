...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => 1166028375;
...
abstract class RustLibApi extends BaseApi {
  Future<SimpleConf> crateApiDocxExportCreateChineseConfig();

  Future<SimpleConf> crateApiDocxExportCreateDefaultConfig();

  Future<SimpleConf> crateApiDocxExportCreateEnglishConfig();

  Future<ExportResult> crateApiDocxExportExportToDocx(
      {required String text, required String outputPath, SimpleConf? config});

  Future<ExportResult> crateApiDocxExportExportToDocxBase64(
  ...
  Future<String> crateApiDocxExportParseFountainText(
      {required String text, SimpleConf? config});

  Future<ParseResult> crateApiDocxExportParseFountainTextWithStats(
      {required String text, SimpleConf? config});

  Future<SimpleConf> crateApiDocxExportSimpleConfDefault();

  Future<String> crateApiDocxExportTestConnection();
}
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Future<ExportResult> crateApiDocxExportExportToDocxBase64(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiDocxExportExportToDocxBase64ConstMeta,
      argValues: [text, config],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiDocxExportExportToDocxBase64ConstMeta =>
      const TaskConstMeta(
        debugName: "export_to_docx_base64",
  ...
  Future<ParseResult> crateApiDocxExportParseFountainTextWithStats(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiDocxExportParseFountainTextWithStatsConstMeta,
      argValues: [text, config],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiDocxExportParseFountainTextWithStatsConstMeta =>
      const TaskConstMeta(
        debugName: "parse_fountain_text_with_stats",
        argNames: ["text", "config"],
      );
